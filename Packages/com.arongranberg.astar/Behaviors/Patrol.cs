...
namespace Pathfinding
{
    ...
    public class Patrol : VersionedMonoBehaviour
    {
        ...
        protected override void Awake()
        {
            ...
            // Shuffle the targets array to get a random order
            ShuffleTargets();
        }
        ...
        /// <summary>
        /// Shuffles the targets array to randomize the patrol order.
        /// </summary>
        private void ShuffleTargets()
        {
            System.Random rng = new System.Random();
            targets = targets.OrderBy(x => rng.Next()).ToArray();
        }
    }
}